...
class ExtendedCounter3: public ExtendedCounter1, public ExtendedCounter2 {  //we have to specify public infront of every class name to make 
//to make use of inheritance ,, try removing public and see what happens
