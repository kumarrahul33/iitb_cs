...
class Planner {
 ...
 public:
  ...
  // void specialDFS(int stn,int day, int destination, int maxStopOvers, int maxTransitTime,listOfObjects<TrainInfoPerStation *>* curr_journey, listOfObjects<listOfObjects<TrainInfoPerStation *>*>* final_journeys, int level=0);

  // listOfObjects<StationConnectionInfo*>* getToStations(int stn){
    // return adjacency[stn].toStations;
  // }
